/**
 * Selector — Content Script for Browser Extension
 * Adapted from the bookmarklet version. Runs in the page context.
 * Exposes window.__selectorDestroy for cleanup via background script.
 */
(function () {
  "use strict";
